...
const PaymentPage = ({ username }) => {
    ...
    const pay = async (amount) => {
        ...
        var options = {
            ...
            "callback_url": `${process.env.NEXTAUTH_PUBLIC_URL}/api/razorpay`,
    ...
    return (
        <>
            ...
            <div className='cover w-full bg-red-50 relative'>
                <Image className='object-cover w-full h-48 md:h-[350px] shadow-blue-700 shadow-sm' src={currentUser.coverpic} alt="" />
